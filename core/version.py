    ...
    VersionInfo(
        ...
        updates=[
            ...
            UpdateItem(
                ...
                description="Bug修复",
                details=[
                    "修复胜率100%时盈亏比显示为inf的问题",
                    "盈亏比现在显示为∞符号",
                ],
            ),
        ],
        breaking_changes=[
            "订单流策略移除 auto_select_symbol、auto_filter_symbol 参数",
            "订单流策略移除 min_volume_ratio、max_volume_ratio 参数",
            "参数优化中 commission_rate 和 slippage 改为固定值",
        ],
        deprecations=[],
    ),
    VersionInfo(
